...
function listarcuatrimotos() {
    let url = "http://144.22.175.9:8082/api/Quadbike/all"
    let cuatrimotosDin = document.getElementById("cuatrimotosDin")
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            cuatrimotosDin.innerHTML = opciones
...
function listarclientes() {
    let url = "http://144.22.175.9:8082/api/Client/all"
...
function cuatrimotoseleccionada() {
    alert("Selecciono el id de la cuatrimoto: " + document.getElementById("cuatrimotosDin").value)
}