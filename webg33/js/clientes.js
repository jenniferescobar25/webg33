...
function editar(id) {
    ...
    url = "http://144.22.175.9:8082/api/Client";
...
function guardarNuevo() {
    ...
    url = "http://144.22.175.9:8082/api/Client/save";
...
function guardarEditar() {
    ...
    url = "http://144.22.175.9:8082/api/Client/update"
...
function guardarBorrar() {
    ...
    let url = "http://144.22.175.9:8082/api/Client";
