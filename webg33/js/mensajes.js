...
let url="http://144.22.175.9:8082/api/Message/all"
...
function editar(id) {
    ...
    url = "http://144.22.175.9:8082/api/Message"
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            let quadbikeIdModif = document.getElementById("quadbikeIdModif")
            ...
            quadbikeIdModif.value = respuesta.quadbike.id
...
function eliminar(id) {
    let url = "http://144.22.175.9:8082/api/Message"
    ...
    solicitud.onreadystatechange = function () {
        ...
        if (solicitud.readyState == 4 && solicitud.status == 200) {
            ...
            document.getElementById("quadbikeList").innerHTML = "<strong>Cuatrimoto: </strong>" + respuesta.quadbike.id
...
function guardarNuevo() {
    ...
    url = "http://144.22.175.9:8082/api/Message/save";
...
function guardarEditar() {
    ...
    let quadbikeIdModif = document.getElementById("quadbikeIdModif").value 
...
function guardarBorrar() {
    let url = "http://144.22.175.9:8082/api/Message/delete"
...
function traerdatos() {
    let registros = ""
    let id = ""
    url="http://144.22.175.9:8082/api/Message/all"
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (let i in respuesta) {
                ...
                registros += "<tr>\
                        ...
                        <td>" + respuesta[i].quadbike.name + " - " + respuesta[i].quadbike.category.name +"</td>\
